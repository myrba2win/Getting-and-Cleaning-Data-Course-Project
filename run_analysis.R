...
setwd("C:/Users/myrba/OneDrive/Desktop/Myrba_RStudio/JHU/Getting-and-Cleaning-Data-Course-Project")

data_url <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
download.file(data_url,destfile = "dataCourse.zip")
unzip("dataCourse.zip")

# Working directory

setwd("C:/Users/myrba/OneDrive/Desktop/Myrba_RStudio/JHU/Getting-and-Cleaning-Data-Course-Project/UCI HAR Dataset")


#  Files for that will be used:
...
write.table( data4, "tidy_dataset.txt", row.names = FALSE )
